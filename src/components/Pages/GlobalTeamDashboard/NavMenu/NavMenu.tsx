...
import { faHome, faLifeRing, faDollarSign, faUsers, faUser } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="w-64 min-h-screen p-6 flex flex-col justify-between text-white" style={{ backgroundColor: '#191919' }}>
            <div className="grid gap-5 grid-cols-1">
                ...
                <ul className="mt-2">
                    ...
                    <NavItem to="#request" Icon={faLifeRing}>Request</NavItem>
                    <NavItem to="#startups" Icon={faDollarSign}>Startups</NavItem>
                    <NavItem to="#mentors" Icon={faUsers}>Mentors</NavItem>
                </ul>
            </div>
